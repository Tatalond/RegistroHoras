...
const NewNess = ({ navigation }) => {
    ...
    const validate = () => {
        ...
        let valid = true;
        if (!inputs.newNess) {
            handleError('Please input newNess', 'newNess')
            valid = false;
        }
    ...
    return <SafeAreaView style={style.safeAreaView}>
        ...
        <ScrollView style={style.container}>
            <Text style={style.title}>NewNess</Text>
            <Text style={style.subtitle}>Enter your details to time record</Text>
            <View style={style.innerContainer}>

                <Input
                    placeholder="Insert your NewNess"
                    placeholderTextColor="#38A3A5"
                    iconName="newspaper-sharp"
                    label="NewNess"
                    error={errors.newNess}
                    onFocus={() => {
                        handleError(null, 'newNess');
                    }}
                    onChangeText={(text) => handleOnChange(text, "newNess")}
                ...
                <Input
                    ...
                    onFocus={() => {
                        handleDateInputFocus('initialDate');
